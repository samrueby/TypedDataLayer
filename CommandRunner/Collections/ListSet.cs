...
namespace CommandRunner.Collections {
	...
	internal class ListSet<T>: ICollection<T> {
		...
		/// </summary>
		public void SortAlphabetically() => list.Sort( ( one, two ) => one.ToString().CompareTo( two.ToString() ) );
	}
}