...
namespace TypedDataLayer.DatabaseAbstraction.Databases {
	...
	public class Oracle: Database {
		...
		//			info.DataSource,
		//			"sys",
		//			null, //ConfigurationLogic.OracleSysPassword,
		...
		//									throw new ApplicationException( "The schema name file was not found, probably because of a corrupt database file in the data package.", e );
